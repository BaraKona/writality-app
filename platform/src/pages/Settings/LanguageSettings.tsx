...
export const LanguageSettings = () => {
	...
	return (
		<div className="h-[calc(100vh-6.4rem)] place-items-center rounded-lg border border-border dark:border-borderDark bg-base dark:bg-baseDark px-3 py-2 overflow-y-auto">
