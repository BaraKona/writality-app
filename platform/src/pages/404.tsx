...
export const FourOFour = () => {
	return (
		<div className="flex bg-base flex-col items-center justify-center h-[calc(100vh-44px)] border-border dark:border-borderDark border rounded-md text-coolGrey-7">
