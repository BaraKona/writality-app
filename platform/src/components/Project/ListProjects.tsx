	...
	return (
		<div className="flex flex-col gap-1.5">
			{projects.map((project) => (
				<div
					className="gap-2 rounded-lg p-2 border border-border dark:border-borderDark hover:border-coolGrey-3 hover:shadow-sm dark:shadow-none dark:hover:border-coolGrey-5 cursor-pointer transition-all duration-200 ease-in-out"
