		...
		<div className="overflow-y-auto h-[calc(100dvh-7.6rem)] basis-[60rem] rounded-lg flex-grow">
			...
			>
				<Image
					...
					fit="cover"
					src={
						"https://images.unsplash.com/photo-1477346611705-65d1883cee1e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
					}
					className=""
				/>
