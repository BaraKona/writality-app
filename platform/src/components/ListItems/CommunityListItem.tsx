	...
	return (
		<Tooltip label={name} position="right" withArrow styles={tooltipStyles}>
			<li onClick={onClick} className="cursor-default list-none">
				<div
					className={`p-1.5 flex mb-0.5 text-xs font-medium rounded-md items-center transition-all ease-in-out duration-500 border-border dark:border-baseDark border dark:text-coolGrey-4 hover:shadow-md dark:hover:shadow-none hover:bg-coolGrey-1 dark:hover:bg-hoverDark ${
						type === "event"
