...
export const SidebarTopNav = ({
  ...
  return (
    <section className="mb-2 flex flex-row justify-center gap-1">
      ...
      <SidebarTopNavItem sidebarNav={sidebarNav} value="create project" navigate={createProject}>
      ...
      >
        <div className="relative">
          <IconInbox size={18} />
          {currentUser.inbox?.filter((inbox: any) => inbox?.notificationRead === false).length >
            0 && <div className="absolute -right-1 -top-1 h-2 w-2 rounded-full bg-fuchsia-500" />}
        </div>
      </SidebarTopNavItem>
      <SidebarTopNavItem
        sidebarNav={sidebarNav}
