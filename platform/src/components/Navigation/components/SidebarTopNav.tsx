...
export const SidebarTopNav: FC<{
	...
	return (
		<Tooltip label={value} position="top" withArrow styles={tooltipStyles}>
			<div
				onClick={navigate}
				className={`p-1 rounded-normal dark:text-coolGrey-4 border border-border dark:border-baseDark dark:hover:shadow-none dark:hover:bg-hoverDark dark:hover:border-hoverDark hover:shadow-md ${
					sidebarNav === value
